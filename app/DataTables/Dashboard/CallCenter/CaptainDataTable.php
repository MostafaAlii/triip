...
class CaptainDataTable extends BaseDataTable {
    ...
    public function dataTable($query): EloquentDataTable {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('vehicleType', function (Captain $captain) {
                $captainVehicleType = $captain->status_caption_type;
                $icon = '';
                if ($captainVehicleType == 'car') {
                    $icon = 'fa-car';
                ...
                return '<i class="fa ' . $icon . ' fa-2x text-dark"></i>';
            })                
            ->rawColumns(['action', 'created_at', 'updated_at','status', 'country_id', 'name','callcenter', 'images', 'car', 'scooter', 'vehicleType']);
    }

    public function query() {
        return Captain::query()->with(['callcenter', 'images', 'car', 'scooters'])->whereCountryId(get_user_data()->country_id)->latest();
    }

    public function getColumns(): array {
        return [
            ['name' => 'id', 'data' => 'id', 'title' => '#', 'orderable' => false, 'searchable' => false,],
            ['name' => 'vehicleType', 'data' => 'vehicleType', 'title' => 'Vehicle','orderable' => false, 'searchable' => false,],
            ['name' => 'name', 'data' => 'name', 'title' => 'Name',],
            ['name' => 'email', 'data' => 'email', 'title' => 'Email', 'orderable' => false, 'searchable' => false,],
            ['name' => 'phone', 'data' => 'phone', 'title' => 'Phone'],
            ['name' => 'car', 'data' => 'car', 'title' => 'Car'],
            ['name' => 'scooter', 'data' => 'scooter', 'title' => 'Scooter'],
