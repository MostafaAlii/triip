...
use App\Models\{ScooterMake, ScooterModel,CaptainScooter, Color, CaptainProfile, CarsCaptionStatus, Captain, Image, Order, OrderDay, OrderHour, CarMake, CarModel, CarType, CategoryCar, CarsCaption};
...
class CaptainController extends Controller
{
    ...
    public function createNewScooter(Request $request) {
        try {
            CaptainScooter::where('captain_id',$request->captain_id)->update([
                'scooter_make_id' => $request->scooter_makeId,
                'scooter_model_id' => $request->scooter_modelId,
                'scooter_number' => $request->number_car,
                'scooter_color' => $request->scooter_number,
                'scooter_year' => $request->scooter_year,
            ]);
            return redirect()->route('CallCenterCaptains.index')->with('success', 'captain scooter created successfully');
        } catch (\Exception $e) {
