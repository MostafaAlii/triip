                        ...
                        <div class="mb-0 form-group">
                            <div class="tab nav-bt">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="scooters-04-tab" data-toggle="tab" href="#scooters-04" role="tab" aria-controls="scooters-04" aria-selected="false">My Scooter</a>
                                    </li>
                                    @endif
                                    <li class="nav-item">
                                ...
                                <div class="tab-content">
                                    ...
                                    @endif
                                    @if($data['captain']->status_caption_type == 'scooter')
                                        @include('dashboard.admin.captains.tabs.scooter.myScooter_content_tab')
                                    @endif
                                </div>
                                <!-- End Tab Content -->
                            </div>
