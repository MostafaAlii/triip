                    ...
                    <div class="acd-group">
                        ...
                        <div class="acd-des">
                            <div>
                                ...
                                <p class="mb-0">
                                    Vehicle Type:
                                    {!! $data['captain'] ? ($data['captain']->status_caption_type == 'car' ? '<i class="fa fa-car"></i> Car' : ($data['captain']->status_caption_type == 'scooter' ? '<i class="fa fa-motorcycle"></i> Scooter' : 'Unknown Vehicle Type')) : 'Unknown Vehicle Type' !!}
                                </p>
