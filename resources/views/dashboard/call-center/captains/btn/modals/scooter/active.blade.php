                ...
                <div class="modal-body mx-auto" style="display: flex; align-items: center; flex-direction: column;">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <img class="object-fit-cover border rounded" width="400px" height="200px" src="{{asset('dashboard/img/' . str_replace(' ', '_', $data['captain']->name) . '_' . $data['captain']->profile->uuid . '/scooter//' . $scooter->scooter_number . '/' .
                                $image->type .
                                '/' . $image->filename)}}"
                                alt="{{ ucfirst(str_replace('_', ' ', $image->photo_type)) }}">
                        </div>
                    </div>
                </div>
